...
func NewMainwindow(app *widgets.QApplication) (mainWindow *MainWindow) {
	...
	portSettingLayout.AddWidget2(portNameLabel, 0, 0, 0)
	portSettingLayout.AddWidget2(buadLabel, 1, 0, 0)
	portSettingLayout.AddWidget2(dataBitLabel, 2, 0, 0)
	portSettingLayout.AddWidget2(checkBitLabel, 3, 0, 0)
	portSettingLayout.AddWidget2(stopBitLabel, 4, 0, 0)
	portSettingLayout.AddWidget2(mainWindow.portNameCombox, 0, 1, 0)
	portSettingLayout.AddWidget2(mainWindow.buadCombox, 1, 1, 0)
	portSettingLayout.AddWidget2(mainWindow.dataBitCombox, 2, 1, 0)
	portSettingLayout.AddWidget2(mainWindow.checkBitCombox, 3, 1, 0)
	portSettingLayout.AddWidget2(mainWindow.stopBitCombox, 4, 1, 0)
	/// 接收设置
	...
	receiveSeetingLayout.AddWidget2(mainWindow.asciiReceiveButton, 0, 0, 0)
	receiveSeetingLayout.AddWidget2(hexReceiveButton, 0, 1, 0)
	receiveSeetingLayout.AddWidget2(mainWindow.autoNewLineReciveCheckBox, 1, 0, 0)
	receiveSeetingLayout.AddWidget2(mainWindow.displayTimeCheckBox, 2, 0, 0)
	/// 发送设置
	...
	sendSettingLayout.AddWidget2(mainWindow.asciiSendButton, 0, 0, 0)
	sendSettingLayout.AddWidget2(hexSendButton, 0, 1, 0)
	sendSettingLayout.AddWidget3(mainWindow.reSendCheckButton, 1, 0, 1, 2, 0)
	sendSettingLayout.AddWidget2(mainWindow.reSendSpinBox, 2, 0, 0)
	sendSettingLayout.AddWidget2(reSendLabel, 2, 1, 0)
